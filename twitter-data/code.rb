...
require 'pry'
#YOUR CODE GOES HERE
#code that yeilds stuff in each example block
 twitter_data.each do |index|
  index.each do |index2|
      if index2[1]["description"] == nil
        puts "#{index2[0]}: N/A"
      else
        puts "#{index2[0]}: #{index2[1]["description"]}"
    end
  end
end
...
twitter_data.each do |index|
  index.each do |index2|
    puts "#{index2[0]} : #{index2[1]["number of followers"]}"
  end
end
# #username from above and length of their last tweet
twitter_data.each do |index|
  index.each do |index2|
  puts "#{index2[0]}'s latest tweet was #{index2[1]["last twenty tweets"].last.length} characters long."
  end
end
...
twitter_data.each do |index|
  index.each do |index2|
  puts "#{index2[0]}  used #{index2[1]["last twenty tweets"].to_s.length} characters in their last twenty tweets."
  end
end
...
twitter_data.each do |index|
  index.each do |index2|
     num_followers << index2[1]["number of followers"]
    if index2[1]["number of followers"] == num_followers.max
      puts "The user with the greatest number of followers is #{index2[0]}"
    end
  end
end
...
twitter_data.each do |index|
  index.each do |index2|
    num_friends << index2[1]["number of friends"]
  end
end

twitter_data.each do |index|  #I know I'm repeating too much stuff here, but it works so I'm taking it!
  index.each do |index2|
    if index2[1]["number of friends"] == num_friends.max
      puts "The user with the greatest number of friends is #{index2[0]}."
    end
  end
end
...
puts "----------------------" #just for added output clarity


twitter_data.each do |index|
  index.each do |index2|
    if index2[1]["location"] != nil
      puts index2[0]
    end
  end
end
